...
type BucketInfo struct {
	...
	// Storage class of bucket. maitian only.
	StorageClass string

	// Location of bucket. maitian only
	Location string
}
...
type BucketInfoDetailInner struct {
	...
	// acl
	Acl BucketACL `xml:"AccessControlList"`
...
func ParseBucketLoggingXML(reader io.Reader) (*BucketLoggingRet, error) {
	b := &BucketLoggingRet{
